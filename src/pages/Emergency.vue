<template>
  <div class="q-py-lg q-px-xl bg-grey-2 background-height">
    <div class="row q-mb-xs">
      <div class="title">Reportes de Emergencias</div>
    </div>
    <q-separator />
    <div v-if="!logs">
      <q-spinner-tail
...
import { titles, staticColumns } from '../data/titlesBanks/emergencys';
...
export default {
  ...
  computed: {
    ...
    logs() {
      return this.$store.getters['logs2/list'];
    },
    columns() {
